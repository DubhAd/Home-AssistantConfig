...
This is my live(-ish) [Home Assistant](https://home-assistant.io/) Core configuration, This instance is running 2023.10.5 
...
* [Home Assistant](https://home-assistant.io/) (2023.10.5)
* [traefik](https://traefik.io/) (2.10.5) with [ZeroSSL](https://zerossl.com/) for remote access (replaced NGINX)
* [Zigbee2MQTT](https://www.zigbee2mqtt.io/) (1.33.2) for Zigbee
...
For Zigbee I use [Zigbee2MQTT](https://www.zigbee2mqtt.io/) (version 1.33.2) running on another system. I use this instead of ZHA because my experience with Z-Wave taught me the value of separation.
