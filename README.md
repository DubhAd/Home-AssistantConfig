# Home Assistant (0.110.4) configuration
This is my primary [Home Assistant](https://home-assistant.io/) Core configuration, This instance is running 0.110.4 on a VM, using an old laptop (Intel Core i5-3230M), with a manual Python virtual environment install [following this guide](https://home-assistant.io/docs/installation/raspberry-pi/).
