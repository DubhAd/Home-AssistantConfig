...
| [CR Smart Home TS0207](https://www.zigbee2mqtt.io/devices/TS0207.html) | Leak sensor | :grey_question: | Bought one to test it out, and it works exactly as described. Ordered a few more for around the house. The downside is battery life is ... shockingly bad. |
...
- The Konke devices are fairly nice, the only problem is that they work on three out of the twenty-six channels.
