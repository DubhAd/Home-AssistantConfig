...
| [TERNCY-DC01](https://www.zigbee2mqtt.io/devices/TERNCY-DC01.html) | Windows | | I've ordered one of these to see if I can find a better Zigbee 3.0 sensor than the Konke |
| [TERNCY-PP01](https://www.zigbee2mqtt.io/devices/TERNCY-PP01.html) | Room sensor | | Combined motion, light, and temperature sensor, it's got a lot going for it, hopefully |
